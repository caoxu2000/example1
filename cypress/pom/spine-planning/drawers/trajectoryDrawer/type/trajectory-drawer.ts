/**
 * Types for the Spine Planning Trajectory Drawer sub-POM
 */
import { pom as pomDrawers } from '../../common/type/drawers'

export namespace pom.spinePlanning.drawers.trajectoryDrawer {
  ...
  export type trajectoryDrawerIcon = JQuery<HTMLElement>
}
